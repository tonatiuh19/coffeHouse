...
function sendmail($addReplyToEmail, $name){
  ...
  try {
       ...
       // $mail->isSMTP();                                            // Set mailer to use SMTP
        ...
        //Recipients
        $mail->setFrom('noreply@coffehouse.mx', 'Bienvenido - CoffeHouse');
        ...
        $mail->Subject = 'Bienvenido | CoffeHouse';
        $mail->Body    = $mess;
